...
function InventoryItemDevicesBondageBenchDraw() {
	...
	DrawText(DialogFind(Player, "BondageBenchPoseLight"), 1125, 800, "white", "gray");
	...
	DrawText(DialogFind(Player, "BondageBenchPoseNormal"), 1375, 800, "white", "gray");
...
function InventoryItemDevicesBondageBenchClick() {
	...
	if ((MouseX >= 1250) && (MouseX <= 1475) && (MouseY >= 550) && (MouseY <= 775) && ((DialogFocusItem.Property.Restrain == null) || (DialogFocusItem.Property.Restrain != "Normal"))) InventoryItemDevicesBondageBenchSetPose("Normal");
