...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "CollarNameTag", Value: 30, Random: false, Prerequisite: "Collared", Time: 5, Difficulty: 3, Extended: true, AllowType: ["Bitch", "Cookie", "Kitten", "Love", "Maid", "Muffin", "Pet", "Puppy", "Slave", "Slut", "Sub", "Toy"] }
		]
	},
...

	{
		...
		Asset: [
			...
			{ Name: "LeatherHoodOpenEyes", Effect: ["GagLight", "DeafLight"], Hide: ["HairFront", "HairBack", "Glasses", "ItemMouth"], Block: ["ItemMouth", "ItemEars", "ItemNeck"], Difficulty: 50, Value: 60, Time: 15, AllowLock: true },
